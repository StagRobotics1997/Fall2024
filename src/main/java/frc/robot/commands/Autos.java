...
public final class Autos {
  ...
  public static Command straightTest(Swerve drive) {
    HashMap<String, Command> eventMap = new HashMap<>();

    return setupAuto("Straight Test", eventMap, drive);
  }

  public static Command splineTest(Swerve drive) {
    HashMap<String, Command> eventMap = new HashMap<>();

    return setupAuto("Spline Test", eventMap, drive);
  }

  private static Command setupAuto(String string, HashMap<String, Command> eventMap, Swerve drive) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'setupAuto'");
  }

  public static Command strafeTest(Swerve drive) {
    HashMap<String, Command> eventMap = new HashMap<>();
