...
public class SwerveModule {
    ...
    public SwerveModuleState getState(){
        return new SwerveModuleState(
            Conversions.RPSToMPS(mDriveMotor.getRotorVelocity().getValueAsDouble(), Constants.SwerveConstants.wheelCircumference), 
    ...
    public SwerveModulePosition getPosition(){
        return new SwerveModulePosition(
            mDriveMotor.getPosition().getValueAsDouble(), new Rotation2d(angleEncoder.getPosition().getValueAsDouble()));
    }
        public void stop() {
        mDriveMotor.set(0);
        mAngleMotor.set(0);
